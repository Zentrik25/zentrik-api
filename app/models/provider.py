...
This model represents any business providing services:
- Medical clinics
- Real estate offices
- Automotive repair shops
- Salons/spas
- Any front-desk business
...
class Provider(Base):
    ...
    sector = Column(String(100), nullable=False, index=True)  # Industry: medical, real_estate, automotive, etc.
    ...
    # Status tracking
    is_active = Column(Boolean, default=True, nullable=False)  # Whether provider is currently active
