...
STATELESS ARCHITECTURE:- No application state is maintained- Each request is independent- Database sessions are created per-request and automatically closed- Safe for horizontal scaling (multiple instances)
"""
...
app = FastAPI(
    ...
    description="API for managing bookings across medical, real estate, automotive, and other 
sectors",
    version="1.0.0",
