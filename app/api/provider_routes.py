...
This layer is STATELESS and handles ONLY HTTP concerns:- Request parsing and validation (handled by FastAPI/Pydantic)- Response formatting- HTTP status codes- Error handling
...
def list_providers(
    ...
    sector: Optional[str] = Query(None, description="Filter by sector (e.g., medical, 
real_estate)"),
    service: ProviderService = Depends(get_provider_service)
):
    """
