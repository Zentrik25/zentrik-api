...
Repository pattern benefits:- Separates database concerns from business logic- Makes testing easier (can mock repository)- Centralizes all database queries in one place
"""
